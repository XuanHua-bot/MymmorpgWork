...
-- --------------------------------------------------
-- Date Created: 05/08/2025 14:24:26
-- Generated from EDMX file: E:\MymmorpgWork\Src\Server\GameServer\GameServer\Entities.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_TGuildMemberTGuild]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TGuildMembers] DROP CONSTRAINT [FK_TGuildMemberTGuild];
GO
IF OBJECT_ID(N'[dbo].[FK_TGuildApplyTGuild]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TGuildApplies] DROP CONSTRAINT [FK_TGuildApplyTGuild];
GO
...
ALTER TABLE [dbo].[TGuildApplies]
ADD CONSTRAINT [FK_TGuildApplyTGuild]
    FOREIGN KEY ([Guild_Id])
    REFERENCES [dbo].[TGuilds]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_TGuildApplyTGuild'
CREATE INDEX [IX_FK_TGuildApplyTGuild]
